  ...
  <div class="min-h-screen bg-gray-50 py-8">
    ...
    <div v-if="showCreateRefund" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-center justify-center min-h-screen px-4">
        <div class="fixed inset-0 bg-black bg-opacity-20" @click="closeCreateRefund"></div>
    ...
    <div v-if="selectedRefund" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-center justify-center min-h-screen px-4">
        <div class="fixed inset-0 bg-black bg-opacity-20" @click="selectedRefund = null"></div>
