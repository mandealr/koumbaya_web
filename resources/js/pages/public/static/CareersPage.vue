<template>
  <StaticPageLayout
    title="Carrières"
    description="Rejoignez notre équipe et transformez l'e-commerce en Afrique"
    meta-description="Intégrez Koumbaya et faites partie d'une équipe dynamique qui transforme le e-commerce en Afrique"
  >
