<template>
  <StaticPageLayout
    title="Affiliés & Influenceurs"
    description="Rejoignez notre programme d'affiliation et gagnez des revenus avec Koumbaya"
    meta-description="Rejoignez notre programme d'affiliation et gagnez des revenus avec Koumbaya"
  >
