<template>
  <div>
    ...
    <!-- Participants Modal -->
    <div v-if="showParticipantsModal" class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
    ...
    <div v-if="showDrawModal" class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
